...
function mine(currentTimestamp, work, miner, merkleRoot, threshold, difficultyCalculator, reportType) {
...
function getNewPreExpDifficulty(currentTimestamp, lastPreviousBlock, blockWhichTriggeredMining, newBlockCount) {
  const preExpDiff = getDiff(currentTimestamp, lastPreviousBlock.getTimestamp(), lastPreviousBlock.getDifficulty(), MINIMUM_DIFFICULTY, newBlockCount, blockWhichTriggeredMining // aka getNewestHeader(newBlock)
